  ...
  return (
    <article className="analysis-card">
      ...
      <div className="ai-chat-card">
        ...
        <div className="command-buttons" style={{ marginTop: '12px' }}>
        ...
        {/* Chat history */}
        <div className="ai-chat-history" style={{ marginTop: '12px' }}>
          <ChatHistoryPanel history={chatHistory} />
        </div>

        {/* Input area */}
        <div className="ai-chat-input-wrap" style={{ marginTop: '12px' }}>
        ...
        <div className="ai-chat-generate" style={{ marginTop: '12px' }}>
        ...
        {chatError && <div className="error" style={{ marginTop: '12px' }}>{chatError}</div>}
      </div>
